...
\begin{cvhonours}
	...
	%---------------------------------------------------------
	\cvhonour{2nd Place} % Award
	{AWS ASEAN AI/ML GameDay} % Event
	{Online} % Location
	{2021} % Date(s)

	%---------------------------------------------------------
	\cvhonour{Finalist} % Award
...
\begin{cvhonours}
	...
	%---------------------------------------------------------
	\cvhonour{3rd Place} % Award
	{WITHCON Hacking Competition Final} % Event
	{Seoul, S.Korea} % Location
	{2015} % Date(s)

	%---------------------------------------------------------
	\cvhonour{Silver Prize} % Award
	...
	%---------------------------------------------------------
	\cvhonour{2nd Award} % Award
	{HUST Hacking Festival} % Event
	{S.Korea} % Location
	{2013} % Date(s)

	%---------------------------------------------------------
	\cvhonour{3rd Award} % Award
	{HUST Hacking Festival} % Event
	{S.Korea} % Location
	{2010} % Date(s)
...
\begin{cvhonours}
	...
	%---------------------------------------------------------
	\cvhonour{AWS Community Builder (Container)} % Award
	{Amazon Web Services (AWS)} % Event
	{} % Location
	{2022} % Date(s)

	%---------------------------------------------------------
	\cvhonour{HashiCorp Ambassador} % Award
	{HashiCorp} % Event
	{} % Location
	{2022} % Date(s)
